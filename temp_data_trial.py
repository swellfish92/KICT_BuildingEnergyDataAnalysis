...
# 원본 데이터를 가져옴
data = pd.read_csv('C:/Users/Swellfish/Documents/result(toe_sum)_v6_20220425.csv')
data['toe_sum_2020'] = data['HEAT_converged_toe_sum_2020'] + data['ELEC_converged_toe_sum_2020'] + data['GAS_converged_toe_sum_2020']
data['toe_sum_2019'] = data['HEAT_converged_toe_sum_2019'] + data['ELEC_converged_toe_sum_2019'] + data['GAS_converged_toe_sum_2019']
data['toe_sum_2018'] = data['HEAT_converged_toe_sum_2018'] + data['ELEC_converged_toe_sum_2018'] + data['GAS_converged_toe_sum_2018']
data['toe_sum_2017'] = data['HEAT_converged_toe_sum_2017'] + data['ELEC_converged_toe_sum_2017'] + data['GAS_converged_toe_sum_2017']
data['toe_sum_2016'] = data['HEAT_converged_toe_sum_2016'] + data['ELEC_converged_toe_sum_2016'] + data['GAS_converged_toe_sum_2016']
data['toe_sum_2015'] = data['HEAT_converged_toe_sum_2015'] + data['ELEC_converged_toe_sum_2015'] + data['GAS_converged_toe_sum_2015']
data['toe_sum_2014'] = data['HEAT_converged_toe_sum_2014'] + data['ELEC_converged_toe_sum_2014'] + data['GAS_converged_toe_sum_2014']
